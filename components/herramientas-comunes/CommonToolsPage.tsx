...
function MovementBadge({ type }: { type: MovimientoHerramienta["tipo"] }) { if (type === "retirada") return <span className="rounded-full bg-amber-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">RETIRÓ</span>; if (type === "devolucion") return <span className="rounded-full bg-emerald-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">COLOCÓ</span>; if (type === "cambio_ubicacion") return <span className="rounded-full bg-violet-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">MOVIDA</span>; if (type === "cambio_estado") return <span className="rounded-full bg-red-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">ESTADO</span>; if (type === "incidencia") return <span className="rounded-full bg-red-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">INCIDENCIA</span>; if (type === "archivo") return <span className="rounded-full bg-zinc-400 px-2.5 py-1 text-[10px] font-black text-zinc-950">ARCHIVO</span>; return null; }
