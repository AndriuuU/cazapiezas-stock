...
export default function LocationField({ initialValue, initialDrawerId, initialDrawer, formRef }: { initialValue?: string | null; initialDrawerId?: number | null; initialDrawer?: InitialDrawer; formRef: RefObject<HTMLFormElement | null> }) {
  ...
  return <div className="space-y-4 md:col-span-2 lg:col-span-4">
    ...
    {mode === "shelf" && <section className="space-y-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4">
    ...
    {mode === "drawer" && <section className="space-y-3 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-4">
